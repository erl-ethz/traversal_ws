...
(cl:defmethod torque-val ((m <ControlCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:torque-val is deprecated.  Use quadrotor_msgs-msg:torque instead.")
  (torque m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControlCommand>)))
  ...
  "9e4ed7fa5379085262ea0d8abaa5d105")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControlCommand)))
  "Returns md5sum for a message object of type 'ControlCommand"
  "9e4ed7fa5379085262ea0d8abaa5d105")
